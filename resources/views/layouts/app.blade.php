...
<head>
    ...
    <title> Event managment systen</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse" style="background-color: #4C9EDC;">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ route('tickets') }}" class="text-white"> <i class="menu-icon ti-list text-white"></i> Tickets </a>
                    </li>
                    @endrole
                    ...
                    <li>
                        <a href="{{ route('viewTicket') }}" class="text-white"> <i class="menu-icon ti-list text-white"></i>View Tickets </a>
                    </li>
